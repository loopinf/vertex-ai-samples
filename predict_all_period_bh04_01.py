...
df_dataset = pd.read_pickle('gs://pipeline-dots-stock/pipeline_root/shkim01/516181956427/ml-with-all-items-20210903153652/get-ml-dataset_4237473832983592960/ml_dataset')
df_preP = df_dataset.copy()

df_bros = pd.read_pickle('gs://pipeline-dots-stock/pipeline_root/shkim01/516181956427/ml-with-all-items-20210901105954/get-bros_-8870815832431656960/bros_univ_dataset')
...
for i in range(idx_start, l_dates.__len__()):
    ...
    dates_for_pred = l_dates[i-3:i+1]  # prediction date
...
# %%
df_pred_all.to_pickle('result_bong04-01.pkl')
# %%
