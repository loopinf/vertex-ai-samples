...
def get_univ_bh01(df, l_dates): # input dataframe : top30s in the period
    ...
    for date in l_dates :
        ...
        df_top30_in_date = df_of_the_day.head(5000)
...
for i in range(idx_start, l_dates.__len__()):
    ...
    dates_for_train = l_dates[i-28: i-3] # 며칠전까지 볼것인가!! 20일만! 일단은
    dates_for_pred = [l_dates[i]] #l_dates[i-9:i+1]  # prediction date
...
# %%
df_pred_all.to_pickle('result_bong09.pkl')
# %%
