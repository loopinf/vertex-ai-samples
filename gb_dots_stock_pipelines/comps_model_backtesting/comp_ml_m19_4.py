...
def get_ml_op(
    ...
    DESC = "model m19-4 is regressor + 25% univ no bros / top30 / no KODEX / no ETN for Training / All items for Prediction"
    ...
    for i in range(idx_start, l_dates.__len__()):
        ...
        df_pred = df_preP[df_preP.date == date_ref] #get_15pct_univ_in_period(df_preP, [date_ref])
