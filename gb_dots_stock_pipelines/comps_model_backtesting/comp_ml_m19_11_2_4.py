...
def get_ml_op(
    ...
    DESC = "model m19-11-2-4 / Classifier / change_p3_over5 / no bros / Incl top30 / Incl. KODEX ETN / +-25% Training / +- 25% Prediction / drop. volume 20d feats"
