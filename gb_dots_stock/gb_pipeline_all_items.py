...
def update_price(
  prediction_result_02 : Input[Dataset],
  updated_result_02 : Output[Dataset]
):
  ...
  df_pred_result = pd.read_pickle(prediction_result_02.path)
  ...
  dir = "/gcs/pipeline-dots-stock/prediction_results_3d_close_10_v01"
  file_name = 'genesis08_result.pkl'
...
def create_awesome_pipeline():
  ...
  op_update_price = update_price(
    prediction_result_02=op_create_model_and_prediction_02.outputs['prediction_result_02']
  )
