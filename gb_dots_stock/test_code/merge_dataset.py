...
#%%
path = 'gs://pipeline-dots-stock/pipeline_root/shkim01/516181956427/ml-with-all-items-20210825204845/get-market-info_6880383126808297472/market_info_dataset'
df_market = pd.read_pickle(path)
